...
def make_json2(opensecrets_id):
	"""Takes the data returned by the get_all_amounts for a particular 
	member of congress and creates a json object to be used to generate 
	a bubble chart with the bubble.html template.
	"""

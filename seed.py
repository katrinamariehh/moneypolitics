...
def load_CampaignFin_cands(session):
    ...
    paths = ['data/CampaignFin/CampaignFin96/cands96.txt']#TEST
...
def load_CampaignFin_cmtes(session):
	...
	paths = ['data/CampaignFin/CampaignFin96/cmtes96.txt'] #TEST
	for path in paths: #TEST
...
def loadCampaignFin_indiv(session):
	...
	paths = ['data/CampaignFin/CampaignFin96/indivs96.txt'] #TEST
	for path in paths: #TEST
		# open each file in the list
		with open(path) as f:
			reader = csv.reader(f, delimiter = ',', quotechar = '|')
...
def loadCampaignFin_PAC(session):
	...
	paths = ['data/CampaignFin/CampaignFin94/pacs94.txt'] #TEST
	for path in paths:	
		# open each file in the list
		with open(path) as f:
			reader = csv.reader(f, delimiter = ',', quotechar = '|')
...
def loadCampaignFin_PAC_other(session):
	...
	paths = ['data/CampaignFin/CampaignFin10/pac_other10.txt', 'data/CampaignFin/CampaignFin96/pac_other96.txt'] #TEST
	for path in paths: #TEST

...
def load_bills(session):
	test_list = ['data/congress/111/bills/hr/hr2619/data.json', 'data/congress/106/bills/hr/hr31/data.json', 'data/congress/104/bills/hr/hr812/data.json', 'data/congress/104/bills/hr/hr1976/data.json', 'data/congress/113/bills/s/s432/data.json', 'data/congress/112/bills/hr/hr3249/data.json', 'data/congress/111/bills/hr/hr2833/data.json', 'data/congress/111/bills/hr/hr4722/data.json', 'data/congress/105/bills/s/s2120/data.json', 'data/congress/100/bills/hr/hr266/data.json']
	# function to create bill objects to database
	# for bill in cpaths['bills']:
	for bill in test_list:
		b = open(bill)
